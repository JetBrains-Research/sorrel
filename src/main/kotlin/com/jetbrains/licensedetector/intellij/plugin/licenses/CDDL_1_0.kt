...
object CDDL_1_0 : SupportedLicense {
    ...
    override val description: String = LicenseDetectorBundle.message("licensedetector.ui.cddl_1_0.description")
    override val permissions: List<String> = listOf(
        LicenseDetectorBundle.message("licensedetector.ui.cddl_1_0.permissions.1"),
        LicenseDetectorBundle.message("licensedetector.ui.cddl_1_0.permissions.2"),
        LicenseDetectorBundle.message("licensedetector.ui.cddl_1_0.permissions.3"),
        LicenseDetectorBundle.message("licensedetector.ui.cddl_1_0.permissions.4"),
        LicenseDetectorBundle.message("licensedetector.ui.cddl_1_0.permissions.5")
    )
    override val permissionToolTips: List<String> = listOf(
        LicenseDetectorBundle.message("licensedetector.ui.cddl_1_0.permissions.1.tooltip"),
        LicenseDetectorBundle.message("licensedetector.ui.cddl_1_0.permissions.2.tooltip"),
        LicenseDetectorBundle.message("licensedetector.ui.cddl_1_0.permissions.3.tooltip"),
        LicenseDetectorBundle.message("licensedetector.ui.cddl_1_0.permissions.4.tooltip"),
        LicenseDetectorBundle.message("licensedetector.ui.cddl_1_0.permissions.5.tooltip")
    )
    override val limitations: List<String> = listOf(
        LicenseDetectorBundle.message("licensedetector.ui.cddl_1_0.limitations.1"),
        LicenseDetectorBundle.message("licensedetector.ui.cddl_1_0.limitations.2")
    )
    override val limitationsToolTips: List<String> = listOf(
        LicenseDetectorBundle.message("licensedetector.ui.cddl_1_0.limitations.1.tooltip"),
        LicenseDetectorBundle.message("licensedetector.ui.cddl_1_0.limitations.2.tooltip")
    )
    override val conditions: List<String> = listOf(
        LicenseDetectorBundle.message("licensedetector.ui.cddl_1_0.conditions.1"),
        LicenseDetectorBundle.message("licensedetector.ui.cddl_1_0.conditions.2")
    )
    override val conditionsToolTips: List<String> = listOf(
        LicenseDetectorBundle.message("licensedetector.ui.cddl_1_0.conditions.1.tooltip"),
        LicenseDetectorBundle.message("licensedetector.ui.cddl_1_0.conditions.2.tooltip")
    )
