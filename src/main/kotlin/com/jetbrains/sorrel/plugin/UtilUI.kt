...
class SorrelUtilUI {
    ...
    companion object {
        ...
        val MAIN_BG_COLOR: Color =
            JBColor.namedColor(
                "Plugins.background",
                JBColor { if (JBColor.isBright()) UIUtil.getListBackground() else Color(0x313335) })
        ...
        val SectionHeaderBackgroundColor =
...
abstract class ComboBoxColumn(
    ...
    private fun prepareComboBox() = SorrelUtilUI.comboBox(CollectionComboBoxModel(emptyList<Any>()))
        .apply {
...
fun JBColor.toHtml() = SorrelUtilUI.toHtml(this)

fun Component.colored(table: JTable, isSelected: Boolean) = this.apply {
    foreground = if (isSelected) table.selectionForeground else table.foreground
    background = if (isSelected) table.selectionBackground else SorrelUtilUI.UsualBackgroundColor
}
