...
class PackagesSmartList(val project: Project) :
    ...
    val installedHeader =
        PackagesSmartItem.Header(com.jetbrains.sorrel.plugin.SorrelBundle.message("sorrel.ui.toolwindow.tab.packages.installedPackages"))
    ...
    init {
        ...
        SorrelUtilUI.overrideKeyStroke(this, "jlist:RIGHT", "RIGHT") { transferFocus() }
        SorrelUtilUI.overrideKeyStroke(this, "jlist:ENTER", "ENTER") { transferFocus() }
        SorrelUtilUI.overrideKeyStroke(this, "shift ENTER") { this.transferFocusUp() }
        SorrelUtilUI.addKeyboardPopupHandler(this, "alt ENTER") { items ->
    ...
    private fun calcDisplayItems(packages: List<PackageDependency>): List<PackagesSmartItem> {
        ...
        val message = com.jetbrains.sorrel.plugin.SorrelBundle.message(
            "sorrel.ui.toolwindow.tab.packages.installedPackages.withCount",
            ...
            ?.let {
                " ${
                    com.jetbrains.sorrel.plugin.SorrelBundle.message(
                        "sorrel.ui.toolwindow.tab.packages.installedPackages.titleSuffix",
                        it
                    )
                }"
            }
