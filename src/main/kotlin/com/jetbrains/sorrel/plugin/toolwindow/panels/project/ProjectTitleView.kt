...
import com.jetbrains.sorrel.plugin.export.ExportJsonLicenseDataAction
...
class ProjectTitleView(
    ...
    private val projectNameLabel = SorrelUtilUI.createBigLabel(projectTitleName(project))
    ...
    private fun projectTitleName(project: Project): String =
        com.jetbrains.sorrel.plugin.SorrelBundle.message("sorrel.ui.toolwindow.tab.project.project.name") + project.name

    private fun createMainProjectLicenseTitle(): JLabel = JLabel(
        com.jetbrains.sorrel.plugin.SorrelBundle.message("sorrel.ui.toolwindow.tab.project.project.main.license")
    ).apply {
