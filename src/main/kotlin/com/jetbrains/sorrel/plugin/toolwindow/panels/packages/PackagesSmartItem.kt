...
sealed class PackagesSmartItem {
    ...
    object Fake : PackagesSmartItem() {
        ...
        val panel = JPanel(BorderLayout()).apply {
            background = SorrelUtilUI.MAIN_BG_COLOR
        }
    }
    ...
    class Header(defaultTitle: String) : PackagesSmartItem() {
        ...
        private val titleLabel = JLabel(defaultTitle).apply {
            foreground = SorrelUtilUI.GRAY_COLOR
        ...
        val panel
            get() = if (visible) {
                SorrelUtilUI.borderPanel(SorrelUtilUI.SectionHeaderBackgroundColor) {
                    SorrelUtilUI.setHeight(this, SorrelUtilUI.SmallHeaderHeight)
                    border = JBEmptyBorder(3, 0, 0, 18)

                    add(SorrelUtilUI.flowPanel(SorrelUtilUI.SectionHeaderBackgroundColor) {
